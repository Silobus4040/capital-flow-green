              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">619 343 3609</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">admin@ccif-inc.com</p>
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-start space-x-2">
                    ...
                    <span><strong>Asset-Based Lending:</strong> Focus on property value, not credit scores</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                    <span><strong>Fast Approval:</strong> Quick decisions and streamlined process</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                    <span><strong>Flexible Terms:</strong> Customized loan structures for your needs</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                    <span><strong>100% Financing:</strong> Complete financing solutions available</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                    <span><strong>Experienced Team:</strong> Decades of commercial lending expertise</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
